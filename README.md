...
- **Persistência de Dados:** Uso de `localStorage` para salvar o progresso da campanha e recordes do jogador.
- **Manipulação de DOM:** Gestão dinâmica de estados da interface (telas de login, jogo e modais).
